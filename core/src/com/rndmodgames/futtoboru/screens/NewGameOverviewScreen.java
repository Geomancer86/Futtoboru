    ...
    public NewGameOverviewScreen(Game parent, List<Country> selectedCountries) {
        ...
        backButton.addCaptureListener(new InputListener() {
            ...
            public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                 ...
                 */
                ((Futtuboru) game).changeScreen(Futtuboru.NEW_GAME_SETUP_SCREEN, selectedCountries);
            }
        });
        ...
        startGameButton.addCaptureListener(new InputListener() {
            ...
            public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                 ...
                 */
                ((Futtuboru) game).getCurrentGame().setSelectedCountries(selectedCountries);
                ((Futtuboru) game).getCurrentGame().getOwner().setPrimaryProfession(primaryProfession);
                ((Futtuboru) game).getCurrentGame().getOwner().setCurrentCountry(startingCountry);
                
                // Avoid setting the UNAVAILABLE dummy Club as Current
                if (startingClub.getId() != null) {
                    ((Futtuboru) game).getCurrentGame().getOwner().setCurrentClub(startingClub);
                }
                
                ((Futtuboru) game).changeScreen(Futtuboru.GAME_SCREEN);
            }
        });
