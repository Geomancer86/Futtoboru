...
this.game = game;
        ...
        availableResolutionsSelectBox.setSelected(Futtuboru.RESOLUTION);
        ...
        availableResolutionsSelectBox.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                Futtuboru.RESOLUTION = res;
                
                // Update User Preferences
                ((Futtuboru) game).updateScreenResolution(res);
                
                // Set to Windowed
                fullScreenCheckBox.setChecked(false);
                
                if (Futtuboru.FULLSCREEN) {
                    ((Futtuboru) game).toggleFullscreen();
                } else {
                    ((Futtuboru) game).setScreen();
                }
            }
        });
