...
/**
 * In this demo we generate a 3D isometric-like terrain
 * 
 * WASD:
 *  - Rotates and moves the camera around
 * 
 * Scroll:
 * 	- Zooms in/out
 * 
 * Click:
 * 	- Moves perspective/camera
 * 
 * NOT SCOPE OF THIS DEMO: fix shadows
 * 
 * 		- https://www.microbasic.net/tutorials/shadow-mapping/Full.html
 * 
 * @author Geomancer86
 */
public class Basic3DTerrainDemo extends BaseBulletTest {
